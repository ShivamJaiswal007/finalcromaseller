...
st.executeUpdate("insert into pmobile(pname,pnumber,pquantity,pmanufacturer,pprice,pdetails) values('"+s41+"','"+s42+"','"+s43+"','"+s44+"','"+s45+"','"+s46+"')");
...
<center>
<form action="productmobile.html">
 	<div class="content">	                          		
